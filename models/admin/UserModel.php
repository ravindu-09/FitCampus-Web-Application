...
class UserModel {
    ...
    public function getAllUsersWithRosters() {
        // Support large GROUP_CONCAT results
    ...
    // Update Student Meta (Life % and Exam Date)
    ...
    public function promoteToCaptain($user_id,$team_id) {
    ...
    // Demote Captain back to Member
    public function demoteToMember($user_id,$team_id) {
